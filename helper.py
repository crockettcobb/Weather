...
p
    ...
    end_date = datetime(year=2015, month=8, day=1)
        ...
        while current_date != end_date:
            ...
            with open('{}/{}-{}-{}.html'.format(station,
                ...
                try:
                    ...
                    #actual_precipitation = weather_data[7].text
                    ...
                    if (record_max_temp_year == '-1' or record_min_temp_year == '-1' or
                            ...
                            int(record_min_temp) > min(int(actual_min_temp), int(average_min_temp))):
                        raise Exception
...
def scrape_station(station):
    ...
    current_date = datetime(year=2015, month=4, day=16)
    end_date = datetime(year=2015, month=4, day=18)
